        ...
        for file in exls_file_list:
            ...
            for stage_idx in range(len(StageFile["file_name"])):
                ...
                if stage_file in file:
                    ...
                    START = {
                        "LEFT":{
                            "START": int(StageFile["left_start_1"][stage_idx]*100),
                            "END": int(StageFile["left_end_1"][stage_idx]*100)
                                },
                        "RIGHT":{
                            "START": int(StageFile["right_start_1"][stage_idx]*100),
                            "END": int(StageFile["right_end_1"][stage_idx]*100)
                                }
                        }
                    # print(right_end)
                    break
