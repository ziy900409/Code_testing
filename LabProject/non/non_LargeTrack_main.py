...
# stage_file_path = r"E:\Hsin\BenQ\ZOWIE non-sym\ZowieNonSymmetry_StagingFile_20241006.xlsx"
...
for folder_name in cortex_folder:
    ...
    gridshot_c3d_list = [file for file in c3d_list if 'LargeTrack' in file]
...
print("輸出檔案： ", folder_path + "6.Statistic\\" + save_place + "All_LargeTrack_motion_table" + formatted_date + ".xlsx")
