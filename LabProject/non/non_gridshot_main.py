...
with pd.ExcelWriter(folder_path + "6.Statistic\\" + save_place + "All_GridShot_motion_table" + formatted_date + ".xlsx",
...
# 儲存檔案  
# all_slope_data.to_excel(folder_path + "6.Statistic\\" + save_place + "All_MedFreq_Static_cortex" + formatted_date + ".xlsx")
        
        
        
# path = r"D:\BenQ_Project\01_UR_lab\09_ZowieAllSeries\5. Statistics\\"
# file_name = "GridShot_distance_statistic_cortex" + formatted_date + ".xlsx"
...
# 儲存檔案  
all_slope_data.to_excel(folder_path + "6.Statistic\\" + save_place + "MedFreq_Static_cortex.xlsx")
