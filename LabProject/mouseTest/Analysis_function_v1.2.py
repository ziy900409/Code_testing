...
def draw_tracjectory(sd3_data_format, amplitude_info, width_info, 
    ...
    for i in range(len(amplitude_info)):
        for ii in range(len(width_info)):
            ...
            suptitle_name = str(sd3_data_format["info"]["participants"][idx]) + "-" + \
                str(sd3_data_format["info"]["condition"][idx]) + "-" + \
                    str(sd3_data_format["info"]["blocks"][idx])
